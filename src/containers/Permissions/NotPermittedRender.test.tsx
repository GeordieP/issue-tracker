...
import NotPermittedRender from './NotPermittedRender';
...
test('Render: User is unauthenticated, default resource level is below required', async () => {
...
test('No Render: User is above required level', async () => {
...
test('Render: User permission level lower than required', async () => {
    const mockAdminPermission: Permission = {
        id: 'pm01',
